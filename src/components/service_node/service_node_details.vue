          ...
          <div class="info row justify-between">
            <div class="infoBox">
              <div class="infoBoxContent">
                ...
                <div class="value">
                  <span
                    ><FormatScala :amount="node.staking_requirement" raw-value
                  /></span>
                </div>
              </div>
            </div>
            <div class="infoBox">
              <div class="infoBoxContent">
                ...
                <div class="value">
                  <span
                    ><FormatScala :amount="node.total_contributed" raw-value
                  /></span>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    openUserWalletInfo(contributorAddress) {
      const url = `https://www.scalasn.com/user/${contributorAddress}`;
